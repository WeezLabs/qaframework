...
/**
 * сласс с настройками RestAssured
 */
public abstract class AbstractRest implements Rest {

    protected static final String GET_CONTENT_TYPE = "application/json;charset=UTF-8";
    protected static final String POST_CONTENT_TYPE = "application/json;charset=UTF-8";
    protected static ObjectMapper mapper = new ObjectMapper().
            configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false).
            enable(SerializationFeature.INDENT_OUTPUT);
    protected static ResourceBundle rb = ResourceBundle.getBundle("server");

    protected Map<String, String> STANDARD_HEADERS = new HashMap<String, String>();
    protected Map<String, String> ADDITIONAL_HEADERS = new HashMap<String, String>();
    protected RequestSpecification postSpecification;
    protected RequestSpecification postSpecificationUnContent;
    protected RequestSpecification postSpecificationUnloadContent;
    ...
    protected RequestSpecBuilder getRequestSpecBuilder = new RequestSpecBuilder();
    protected RequestSpecBuilder postRequestSpecBuilder = new RequestSpecBuilder();
    protected RequestSpecBuilder postRequestUnContentSpecBuilder = new RequestSpecBuilder();
    protected RequestSpecBuilder postRequestUnloadContentSpecBuilder = new RequestSpecBuilder();
    protected ResponseSpecBuilder responseSpecBuilder = new ResponseSpecBuilder();
    ...
    public AbstractRest(Module module) {
        this.module = module;
        //инициация переменных
        basePath = rb.getString(module.getModuleName().toUpperCase() + "_BASE_PATH");
        ...
        String xHost = rb.getString(module.getModuleName().toUpperCase() + "_SERVER").replaceAll("(\\$\\{" + module.getModuleName() + "-server})", rb.getString(module.getModuleName().toUpperCase() + "_DEFAULT_SERVER"));
        baseUri = (ssl ? "https://" : "http://") + xHost;
        port = Integer.parseInt(rb.getString(module.getModuleName().toUpperCase() + "_SERVER_PORT").replaceAll("\\$\\{" + module.getModuleName() + "-port}", rb.getString(module.getModuleName().toUpperCase() + "_DEFAULT_PORT")));
